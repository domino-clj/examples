(ns user
  ...
  (:require
    ...
    [domino.simpleui-example.core :refer [start-app]]))
...
(defn dev-prep!
  ...
  (integrant.repl/set-prep! (fn []
                              (-> (domino.simpleui-example.config/system-config {:profile :dev})
                                  (ig/prep)))))

(defn test-prep!
  []
  (integrant.repl/set-prep! (fn []
                              (-> (domino.simpleui-example.config/system-config {:profile :test})
                                  (ig/prep)))))
